        ...
        <div class="row">
            <div class="col2">
                ...
                <div class="small-img-row">
                    ...
                    <div class="small-img-col">
                        <img src="images\product2_small1.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="images\product2_small2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="images\product2_small3.jpg" width="100%" class="small-img">
                    </div>
                </div>
            </div>
            <div class="col2">
                <p>Beekeeping Veil Hat</p>
                <h1>Humble Bee</h1>
                <h4>$39.95</h4>
                <select>
                ...
                <p>Polycotton beekeeper veil with round hat, reinforced brims, and elastic shoulder straps.
                    <br>
                    Medium-weight 50% cotton / 50% synthetic blend (260 gsm) provides outstanding protection against bee
                    stings, plus all-day comfort in most weather conditions.
                    <br>
                    Universal fit with an oversized mesh to protect your neck and shoulders, plus elastic shoulder
                    straps to keep everything comfortably in place.
                    <br>
                    Unisex design for men and women.
                    <br>
                    Humble Bee donates 10% of earnings to not-for-profit organizations that encourage local beekeeping
                    activities and promote bee conservation efforts.
                </p>
            </div>
        </div>
    </div>
